        ...
        choices: [
            {
                ...
                value: () => {
                    ...
                    console.log("mjsrodrigues4@gmail.com is awaiting for your email!\nSee you soon.\n");
                },
            },
            {
                name: "Just quit.",
...
const data = {
    ...
    github: chalk_1.default.gray("https://github.com/") + chalk_1.default.green("mariorodrigues10"),
    web: chalk_1.default.white("https://") +
        chalk_1.default.cyan("mariorodrigues10.github.io") +
        chalk_1.default.hidden("/?ref=npx"),
    npx: `${chalk_1.default.red("npx")} ${chalk_1.default.white("mariorodrigues10")}`,
...
const me = (0, boxen_1.default)([
    ...
    ``,
    `${chalk_1.default.italic("Avid enthusiast for open source software development.")}`,
